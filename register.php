...
<body class="body">
    ...
    -->
        ...
        <div class="main-panel" id="main-panel">
            ...
            <div class="panel-header panel-header-lg">
                ...
                <form id="loginForm" action="registerdb.php">
                    <div class="row">
                        <div class="col-4">
                        </div>
                        ...
                        <div class="col-3" id="div-datalist-tag">
                    ...
                    <div class="row">
                        ...
                        <div class="col-3" id="div-datalist-tag">
                            <input type="text" id="password-input-tag-1" class="form-control" placeholder="Password"
                                autocomplete="off">
                    ...
                    <div class="row">
                        ...
                        <div class="col-3" id="div-datalist-tag">
                            <input type="text" id="password-input-tag-2" class="form-control" placeholder="Password"
                                autocomplete="off">
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-1">
                            <button id="register-btn-tag" class=" btn btn-primary">Register</button>
                        </div>
                        <div class="col-1">
    ...
    <script>
    /*Register btn*/
    document.getElementById("register-btn-tag").addEventListener('click', (e) => {
        e.preventDefault();
        registerbtn();
    });
    var registerbtn = () => {
        var username = document.getElementById('username-input-tag').value;
        var password1 = document.getElementById('password-input-tag-1').value;
        var password2 = document.getElementById('password-input-tag-2').value;
        ...
        if (!(password2)) {
            errorTxt = 'Enter Retype Password';
            errorprint(errorTxt);
            return false;
        }
        if (password1 != password2) {
            errorTxt = 'Password Mismatch Retry';
            errorprint(errorTxt);
            return false;
        }
        $.post('registerdb.php', {
